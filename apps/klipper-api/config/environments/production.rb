...
Rails.application.configure do
  ...
  # SolidQueue is unused today (no Job subclasses, no .perform_later calls anywhere) —
  # deferred until a real background job exists; :async needs no extra database role.
